...
const GallselectBtn = document.querySelector('.gallery__select-btn');
const GallselectBody = document.querySelector('.gallery__select-body');
const GallselectItem = document.querySelectorAll('.gallery__select-item');
const GallselectIcon = document.querySelector('.gall-icon');
...
document.querySelectorAll('.gallery__item-no-focus').forEach(function(focout){
...
GallselectItem.forEach(function(selectItem){
  selectItem.addEventListener('click' , function(e){
    e.stopPropagation()
    document.querySelector('.gallery__select-hdr').innerText = this.innerText;
    document.querySelector('.gallery__input-hidd').value = this.dataset.value;
    GallselectBody.classList.remove('gallery__select-body-vsbl');
    GallselectIcon.classList.remove('gall-icon-active');
  })
});
